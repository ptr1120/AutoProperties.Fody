...
public class GenericBaseSome<TProperty> : ChangeTrackable
{
    ...
    {
        get { return GetValue("GenericProperty", typeof(TProperty), k__PropertyInfo, k__BackingField, k__BackingField, ref k__BackingField); }
        set { SetValue("GenericProperty", typeof(TProperty), k__PropertyInfo, value, value, ref k__BackingField); }
    }
}
...
public class SomeClassWithoutGenerics : ChangeTrackable
{
    ...
    {
        get { return GetValue("ValueProperty", typeof(int), v__PropertyInfo, v__BackingField, v__BackingField, ref v__BackingField); }
        set { SetValue("ValueProperty", typeof(int), v__PropertyInfo, value, value, ref v__BackingField); }
    }

    public string ReferenceProperty
    {
        get { return GetValue("ReferenceProperty", typeof(string), r__PropertyInfo, r__BackingField, r__BackingField, ref r__BackingField); }
        set { SetValue("ReferenceProperty", typeof(string), r__PropertyInfo, value, value, ref r__BackingField); }
    }

    public string[] ArrayProperty
    {
        get { return GetValue("ArrayProperty", typeof(string[]), a__PropertyInfo, a__BackingField, a__BackingField, ref a__BackingField); }
        set { SetValue("ArrayProperty", typeof(string[]), a__PropertyInfo, value, value, ref a__BackingField); }
    }
}
